...
# Comprehensive prompt data for all categories
PROMPT_DATABASE = {
    "homework": {
        "id": "homework",
        ...
        "color": "linear-gradient(135deg, #1a1a3e 0%, #2d1b4e 100%)",
        "prompts": [
    ...
    "creative": {
        ...
        "color": "linear-gradient(135deg, #2d1b4e 0%, #4a1942 100%)",
        "prompts": [
    ...
    "gaming": {
        ...
        "color": "linear-gradient(135deg, #1a2a4a 0%, #0d1f3c 100%)",
        "prompts": [
    ...
    "science": {
        ...
        "color": "linear-gradient(135deg, #0d2818 0%, #1a3d2e 100%)",
        "prompts": [
    ...
    "art": {
        ...
        "color": "linear-gradient(135deg, #3d1a3d 0%, #4a1942 100%)",
        "prompts": [
    ...
    "coding": {
        ...
        "color": "linear-gradient(135deg, #0a1628 0%, #1a2744 100%)",
        "prompts": [
    ...
    "reading": {
        ...
        "color": "linear-gradient(135deg, #2d1f1f 0%, #3d2929 100%)",
        "prompts": [
    ...
    "languages": {
        ...
        "color": "linear-gradient(135deg, #1f2d1f 0%, #2a3d2a 100%)",
        "prompts": [
    ...
    "health": {
        ...
        "color": "linear-gradient(135deg, #1a2d3d 0%, #1f3d4d 100%)",
        "prompts": [
...
async def get_all_categories():
    """Get all prompt categories with their prompts"""
    categories = []
    for cat_id, cat_data in PROMPT_DATABASE.items():
        categories.append({
            "id": cat_data["id"],
            ...
            "promptCount": len(cat_data["prompts"])
        })
    return categories

@api_router.get("/prompts/category/{category_id}")
async def get_category_prompts(category_id: str):
    """Get all prompts for a specific category"""
    if category_id not in PROMPT_DATABASE:
        raise HTTPException(status_code=404, detail="Category not found")
    
    return PROMPT_DATABASE[category_id]

@api_router.get("/prompts/all")
